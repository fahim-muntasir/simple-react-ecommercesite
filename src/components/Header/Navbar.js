...
export default function Navbar() {
  ...
  return (
    <div className=" w-11/12 m-auto flex justify-between py-8 items-center ">
      ...
      <div className="w-6/12">
        ...
        <div
          className={`fixed md:fixed lg:hidden bg-zinc-800 h-[100%] w-full top-0 left-0 bottom-0 right-0 transition-all duration-300  bg-opacity-60 z-50 overflow-hidden ${
            navShowHide ? " visible opacity-100 " : "invisible opacity-0 "
          }`}
        >
          <nav
      ...
      <div className="w-3/12">
        <ul className="flex justify-end gap-5 text-gray-600 cursor-pointer text-2xl  ">
          <li>
          ...
          <li>
            <Link to={"/card"}>
              <AiOutlineShopping className=" hover:text-green-500 duration-300" />
            </Link>
          </li>
        </ul>
